...
async function run() {
	...
	const asciiArt = figlet.textSync("Bonk.fun Bundler", {
		font: "Standard",
	...
	while (running) {
		...
		console.log(chalk.green("| 1. Jito bundler             |"));
		console.log(chalk.green("| 2. Delayed bundle           |"));
		console.log(chalk.green("| 3. Snipe only               |"));
		// console.log(chalk.green("| 4. Sell token               |"));
		console.log(chalk.green("| 4. Retrieve SOL             |"));
